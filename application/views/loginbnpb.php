            ...
            <div class="login-box ptb--100">
                <form>
                    ...
                    <div class="login-form-body">
                        <div class="form-gp">
                            <label for="exampleInputEmail1">Username BNPB</label>
                        ...
                        <div class="submit-btn-area">
                            ...
                            <button id="form_submit" type="button" onclick="window.location='<?php echo site_url("Welcome/bnpbdashboard");?>'">Submit <i class="ti-arrow-right"></i></button>
                        </div>
