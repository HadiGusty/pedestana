                ...
                <form>
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="submit-btn-area">
                            ...
                            <button id="form_submit" type="button" onclick="window.location='<?php echo site_url("Welcome/masyarakatdashboard");?>'">Submit <i class="ti-arrow-right"></i></button>
                        </div>
