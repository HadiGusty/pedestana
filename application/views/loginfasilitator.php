            ...
            <div class="login-box ptb--100">
                <form>
                    <div class="login-form-head">
                        <h4>Masuk Fasilitator</h4>                        
                    </div>
                    <div class="login-form-body">
                        <div class="form-gp">
                            <label for="exampleInputEmail1">Username Fasilitator</label>
                        ...
                        <div class="submit-btn-area">
                            ...
                            <button id="form_submit" type="button" onclick="window.location='<?php echo site_url("Welcome/fasilitatordashboard");?>'">Submit <i class="ti-arrow-right"></i></button>
                        </div>
