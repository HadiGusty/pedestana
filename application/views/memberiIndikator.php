...
<html lang="en">
  ...
  <head>
    ...
    <title>BNPB - Memberi Indikator</title>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Memberi Indikator</li>
          </ol>

           <!-- DataTables Example -->
           <h4>Mengisi Indikator Desa Tangguh Bencana</h4>
           <hr>
           <div class="col-lg-10">
              <div class="card">                  
                      ...
                      <div class="table-responsive">
                          <table class="table table-bordered table-hover">
                              ...
                              <tbody>
                                  <tr>
                                      <td rowspan="2">1</td>
                                      <td rowspan="2">Desa Tangguh Bencana Utama</td>
                                      <td><input type="text" id="text-input" name="indikator" class="form-control" height="50px"></td>                                     
                                  </tr>
                                  <tr>                                                                                                                
                                      <td><input type="text" id="text-input" name="indikator" class="form-control"></td>
                                  </tr>
                                  <tr>
                                      <td rowspan="2">2</td>
                                      <td rowspan="2">Desa Tangguh Bencana Madya</td>
                                      <td><input type="text" id="text-input" name="indikator" class="form-control"></td>
                                  </tr>
                                  <tr>                                      
                                      <td><input type="text" id="text-input" name="indikator" class="form-control"></td>
                                  ...
                                  <tr>
                                      <td rowspan="2">3</td>
                                      <td rowspan="2">Desa Tangguh Bencana Pertama</td>
                                      <td><input type="text" id="text-input" name="indikator" class="form-control"></td>
                                  </tr>
                                  <tr>                                      
                                      <td><input type="text" id="text-input" name="indikator" class="form-control"></td>
                          ...
                          <button type="submit" class="btn btn-primary1 btn-sm"> 
                              Simpan
                          </button> <br />
                          <br />                          
                      </div>
